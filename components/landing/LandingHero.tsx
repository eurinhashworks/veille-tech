        ...
        <div className="container mx-auto px-6 pt-16 pb-24 text-center relative z-10">
            ...
            <div className="flex flex-col items-center gap-4">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    <Link href={ROUTES.LOGIN.path} className="flex items-center gap-2 bg-primary/10 border border-primary/20 px-5 py-2.5 rounded-full text-sm font-semibold text-primary hover:bg-primary hover:text-white transition-all shadow-sm">
                        <span className="material-icons text-base">smart_toy</span> IA & GPT
                    </Link>
                    <Link href={ROUTES.LOGIN.path} className="flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 px-5 py-2.5 rounded-full text-sm font-semibold text-blue-600 dark:text-blue-400 hover:bg-blue-500 hover:text-white transition-all shadow-sm">
                        <span className="material-icons text-base">code</span> Dev Tools
                    </Link>
                    <Link href={ROUTES.LOGIN.path} className="flex items-center gap-2 bg-purple-500/10 border border-purple-500/20 px-5 py-2.5 rounded-full text-sm font-semibold text-purple-600 dark:text-purple-400 hover:bg-purple-500 hover:text-white transition-all shadow-sm">
                        <span className="material-icons text-base">cloud</span> SaaS
                    </Link>
                    <Link href={ROUTES.LOGIN.path} className="flex items-center gap-2 bg-green-500/10 border border-green-500/20 px-5 py-2.5 rounded-full text-sm font-semibold text-green-600 dark:text-green-400 hover:bg-green-500 hover:text-white transition-all shadow-sm">
